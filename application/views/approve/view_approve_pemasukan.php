            ...
            <table class="table table-hover table-striped" id="tbl_to_tables">
              ...
              <tbody>
                ...
                if ($value->bukti_kwitansi != '') {
                  $img = '<a href="'.base_url('assets/uploads/images/pengeluaran/'.$value->bukti_kwitansi).'" data-lightbox="'.$value->id_pemasukan.'"></a><img src="'.base_url('assets/uploads/images/pengeluaran/'.$value->bukti_kwitansi).'">';
                } else {
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-icons btn-inverse-primary ml-2"
                      onclick="setItem('<?= base_url('approvepemasukan/accept/'.$value->id_pemasukan) ?>','Terima')">
                      <i class="fa fa-check"></i></button>
                    <button type="button" class="btn btn-icons btn-inverse-danger"
                      onclick="setItem('<?= base_url('approvepemasukan/reject/'.$value->id_pemasukan) ?>','Tolak')">
