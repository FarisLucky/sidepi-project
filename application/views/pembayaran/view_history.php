            ...
            <div class="row">
              <div class="col-sm-12 text-center mb-3">
                <a href="<?= base_url('pembayaran/bayar/'.$id_pembayaran) ?>"
                  class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i>&nbsp;Bayar</a>
            ...
            <div class="row">
              <div class="col-sm-5">
                <div class="row">
                  ...
                  <div class="col-sm-5">
                    <small
                      class="txt-filter border-0"><?= number_format($pembayaran['total_tagihan'],2,',','.') ?></small>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-5">
                    <small
                      class="txt-filter border-0"><?= number_format($pembayaran['total_bayar'],2,',','.') ?></small>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
