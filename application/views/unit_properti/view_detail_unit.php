          ...
          <div class="row">
            <div class="col-sm-8">
              <div class="form-group">
                ...
                <input type="text" name="txt_tanah" class="form-control" id="txt_tanah" value="<?= $unit->luas_tanah ?>"
                  readonly>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="satuan_tanah" class="form-control" value="<?= $unit->satuan_tanah ?>" readonly>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="txt_harga" class="form-control" id="txt_harga" value="<?= $unit->harga_unit ?>"
                  readonly>
