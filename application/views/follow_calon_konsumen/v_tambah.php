                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select name="val_nama_konsumen" id="input_calon_konsumen"
                          class="form-control <?= form_error('val_nama_konsumen') ? 'is-invalid' : '' ?>">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" id="input_keterangan" name="val_keterangan"
                          ...
                          class="form-control <?= form_error('val_keterangan') ? 'is-invalid' : '' ?> "
                          rows="5"></textarea>
                        <div class="invalid-feedback">
